...
--nr_2tabele+ = 2, nr_distinct = 1, nr_where = 2 
...
--nr_2tabele+ = 3, nr_group_by = 1, nr_having = 1
...
HAVING COUNT(T.id_team)>1;

--nr_2tabele+ = 7, nr_where = 5
...
-- nr_interogari-m-n = 1, nr_group_by = 1
