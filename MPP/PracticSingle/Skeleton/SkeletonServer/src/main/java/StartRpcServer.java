...
import skeleton.persistence.repository.jdbc.*;
...
public class StartRpcServer {
    ...
    public static void main(String[] args) {
        ...
        IGameConfigRepository gameConfigRepository = new GameConfigDbRepository(serverProps, sessionFactory);
        IGameDataRepository gameDataRepository = new GameDataDbRepository(serverProps, sessionFactory);
        IGameFinishRepository gameFinishRepository = new GameFinishDbRepository(serverProps, sessionFactory);
        ...
        ISkeletonServices competitionServerImplementation = new SkeletonServicesImplementation(userRepository,gameConfigRepository, gameDataRepository, gameFinishRepository, moveRepository, historyRepository);
